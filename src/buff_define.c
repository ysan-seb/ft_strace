...
int	open_def(long param)
{
	...
	static long	o_def[] = {
		O_CREAT, O_EXCL, O_NOCTTY, O_TRUNC, O_APPEND, O_NONBLOCK, O_SYNC,
		O_FSYNC, O_ASYNC, __O_LARGEFILE, __O_DIRECTORY, __O_NOFOLLOW, __O_CLOEXEC, __O_DIRECT, __O_NOATIME, __O_PATH, __O_DSYNC
	};
	static char     *o_string_def[] = {
		"O_CREAT", "O_EXCL", "O_NOCTTY", "O_TRUNC", "O_APPEND", "O_NONBLOCK", "O_SYNC",
		"O_FSYNC", "O_ASYNC", "O_LARGEFILE", "O_DIRECTORY", "O_NOFOLLOW", "O_CLOEXEC", "O_DIRECT", "O_NOATIME", "O_PATH", "O_DSYNC"
	};
